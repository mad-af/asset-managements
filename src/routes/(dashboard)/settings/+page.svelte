<script lang="ts">
  ...
  import { NotificationCard, GeneralInfo, LanguageTime, Sessions, UserProfile, Accounts } from '$lib/components';
  import type { InputField, SessionProps } from '$lib/components';
  ...
  // Type assertion untuk Users array
...
<main class="p-4">
  <div class="grid grid-cols-1 space-y-2 xl:grid-cols-3 xl:gap-3.5 dark:bg-gray-900">
    ...
    <div class="col-span-full space-y-4 xl:col-auto">
      ...
      <!-- SocialAccounts component removed - file not found -->
    ...
    <div class="col-span-2 space-y-4">
      <GeneralInfo {inputs} />
      <!-- PasswordInfo component removed - file not found -->
