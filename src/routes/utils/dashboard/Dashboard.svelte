<script lang="ts">
  ...
  import { ChartWidget, Stats, More, ActivityList, ProductMetricCard, CategorySalesReport, DarkChart, Traffic, getChartOptions } from '$lib/components';
  import type { DeviceOption } from '$lib/components/types';
